...
/**
 * Servlet implementation class DatePrint_DoGet
 */
@WebServlet("/DatePrint_DoGet")
public class DatePrint_DoGet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DatePrint_DoGet() {
		super();
